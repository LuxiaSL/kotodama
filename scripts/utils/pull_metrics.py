...
Usage:
    ...
    python scripts/utils/pull_metrics.py --scp gpu-host:~/workspace/kotodama/checkpoints/openwebtext-ddv1/

    # Both
    python scripts/utils/pull_metrics.py \
        --wandb aethera/kotodama-ddv1-openwebtext/run_id \
        --scp gpu-host:~/workspace/kotodama/checkpoints/openwebtext-ddv1/ \
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Remote checkpoint dir: gpu-host:~/path/to/checkpoint_dir/",
    )
    parser.add_argument(
