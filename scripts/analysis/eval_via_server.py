...
Usage::
    ...
    python scripts/analysis/eval_via_server.py --url http://gpu-host:2222 --name owt-ddv1
...
def main() -> None:
    ...
    p.add_argument("--url", type=str, required=True, help="Server URL (e.g. http://gpu-host:2222)")
